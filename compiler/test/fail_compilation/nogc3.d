...
fail_compilation/nogc3.d(58):        function `nogc3.testClosure1.bar` closes over variable `x`
...
fail_compilation/nogc3.d(70):        function `nogc3.testClosure3.bar` closes over variable `x`
...
fail_compilation/nogc3.d(89): Error: array literal in `@nogc` function `nogc3.foo13702` may cause a GC allocation
fail_compilation/nogc3.d(95): Error: array literal in `@nogc` function `nogc3.bar13702` may cause a GC allocation
